...
func getProductRouter() RouteList {
	prefix := "/product"
	var routes = RouteList {
		Route{ "ProductCreate", "POST",   prefix + "/create", createProduct, false, },
		Route{ "ProductDelete", "DELETE", prefix + "/{id}/delete", deleteProduct, false, },
		Route{ "ProductEdit",   "PUT",  prefix + "/{id}/edit", editProduct, false, },
		Route{ "ProductGetList","GET",  prefix, getProductList, false, },
		Route{ "ProductGetItem","GET",  prefix + "/{id}/get", getProductItem, false, },
		Route{ "ProductCount",  "GET",  prefix + "/count", getProductCount, false, },
	}

  return routes
}

func getProductData(w http.ResponseWriter, r *http.Request) (Product, error){
...
func getProductItem(w http.ResponseWriter, r *http.Request) {
	var data Product
